...
public class MyWindow extends JFrame {
	 ...
	 */
	public void showFigures(GeometricFigure[] figs) {
		panel.setFigs(figs);
...
class MyPanel extends JPanel {
	...
	private GeometricFigure[] figs = null;
	 ...
	 * @return circles
	 */
	public GeometricFigure[] getFigs() {
		return figs;
	}
	 ...
	 */
	public void setFigs(GeometricFigure[] figs) {
		this.figs = figs;
	}
	...
	public void paintComponent(Graphics g) {
		...
		if (figs!=null) {
			for (int i=0;i<figs.length;i++) {
				if (figs[i] instanceof GraphicFigure) {
					((GraphicFigure)figs[i]).paint(g);
				}
			}
		}
